...
class ProductService {
  ...
  Future<List<Product>> fetchProducts() async {
    try {
      ...
      List<Product> products = snapshot.docs.map((doc) {
        ...
        print('Document Data: $data'); // Logging data dokumen
        return Product.fromJson(doc.id, data); // Mengambil id dari doc.id dan data dari Firestore
      }).toList();
      return products;
    } catch (e) {
  ...
  Future<Product> fetchProductById(String productId) async {
    try {
      ...
      return Product.fromJson(docSnapshot.id, data);
    } catch (e) {
